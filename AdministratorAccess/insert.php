...
//checks if product id is already taken or not
if(!$resultCheck['PRODUCT_ID']){
    //inserts new product into products table
    $sql = "INSERT INTO products VALUES(".$pid.",'".$pname."',".$price.")";
    $result = mysqli_query($conn, $sql);
    $temp = 0;
    ...
    $sql = "INSERT INTO products_has_designer VALUES(".$pid.",".$temp['DESIGNER_ID'].")";
    $result = mysqli_query($conn, $sql);
    echo "<br>SUCCESSFUL INPUT<br>";
}
else{
    echo "<br> ERROR: PRODUCT ID IS BEING USED<br>";
